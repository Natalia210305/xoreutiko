    ...
    <main className={`${ebGaramond.className} max-w-[1600px] mx-auto p-6 md:p-20 text-slate-900 bg-white min-h-screen`}>      <header className="mb-16 text-center">
      ...
      <section className="space-y-12 text-xl leading-relaxed italic text-justify">
        <div className="flex flex-col md:flex-row gap-8 items-center bg-slate-50 p-8 rounded-3xl border border-slate-100">
          ...
          <p>
            Η Αδελφότητα συνεργάζεται με πολιτιστικούς και εκπαιδευτικούς φορείς, μουσεία και οργανισμούς, για την προώθηση της λαογραφίας και της πολιτιστικής κληρονομιάς των Σαρακατσαναίων.
          </p>
        </div>

        <p>
          Πιστεύουμε στην εξωστρέφεια και στη δύναμη των συνεργασιών. Παραμένουμε πάντα ανοικτοί σε νέες προτάσεις, κοινές πολιτιστικές πρωτοβουλίες και εκπαιδευτικά προγράμματα που αφορούν τον νομαδικό βίο και την παράδοση των Σαρακατσαναίων.
        </p>
