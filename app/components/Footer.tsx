...
export default function Footer() {
  ...
  return (
    <footer className={`${ebGaramond.className} bg-[#f8f9fa] border-t border-slate-200 pt-16 pb-8 mt-20 text-slate-700`}>
      ...
      {/* Ενότητα Σχεδιαστή */}
      <div className="mt-16 py-12 border-t border-slate-100 text-center">
        <p className="text-slate-500 text-lg md:text-xl italic flex flex-col gap-2">
          Σχεδιασμός & Ανάπτυξη Ιστοσελίδας
          <span className="text-slate-800 font-bold not-italic text-xl md:text-2xl tracking-tight">
            Μπάρκα Ναταλία
          </span>
        </p>
      </div>
